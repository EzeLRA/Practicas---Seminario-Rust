...
//Se debe importar serde y serde_json
...
/*
    EXTRACCION DEL EJERCICIO 5 DEL TP4
*/
...
#[derive(Debug, Clone,PartialEq,Serialize, Deserialize)]
//Valor(de la unidad) = Se ingresa el monto valorado en fiat
...
/**
        IMPLEMENTACION EJERCICIO 6 - TP5
**/
...
//Implementacion extra para la plataforma
impl Plataforma{
    fn get_balances(&self)->Vec<Usuario>{
        return self.usuarios.clone();
    }
    fn get_comprobantes(&self)->Vec<TiposTransacciones>{
